export class Hostel {
    constructor(id, hostelName, info, profilePicUrl, pricing, salesPitch, foodInfo, livingOptions, attractions, isPetFriendly, isCovidSafe, location, hasLockers, hasGenderedRoom, reviews, zipCode){
        this.id = id;
